...
;// CONCATENATED MODULE: ./src/js/components/message/TextMessage.js

class TextMessage extends message_Message {
  constructor(text) {
    super();
    this.text.textContent = text;
  }
}
/* harmony default export */ const message_TextMessage = (TextMessage);
;// CONCATENATED MODULE: ./src/js/components/message/AudioMessage.js

class AudioMessage extends message_TextMessage {
...
/* harmony default export */ const message_AudioMessage = (AudioMessage);
;// CONCATENATED MODULE: ./src/js/utils.js
const getCoordinatesFromInput = text => {
  ...
  awaiter = () => {
    return new Promise((resolve, reject) => {
      this.inputCoordinatesForm.addEventListener("submit", e => {
        ...
        let coordinates;
        try {
          coordinates = this.getCoordinatesFromInput(this.inputCoordinates.value);
        } catch (e) {
          if (this.inputError && this.inputError.closest(".input-coordinates-form")) {
...
;// CONCATENATED MODULE: ./src/js/components/Timeline.js
...
class Timeline {
  ...
  initGeolocationRequest = async () => {
    this.modal = new components_Modal();
    this.modal.show();
    this.geolocation = {};
    ...
    if (navigator.mediaDevices) {
      try {
        ...
        this.recorder.addEventListener("stop", async () => {
          ...
          this.msg = new message_AudioMessage(this.inputMsg.value, url);
          this.inputMsg.value = "";
        ...
        this.recorder.start();
        try {
          this.applyRecordAudioBtn.removeEventListener("click", this.applyAudioRecord);
        } catch (e) {
          console.log(e);
        }
        this.applyRecordAudioBtn.addEventListener("click", this.applyAudioRecord);
        try {
          this.stopRecordAudioBtn.removeEventListener("click", this.stopAudioRecord);
        } catch (e) {
          console.log(e);
        }
  ...
  sendMsgHandler = async () => {
    ...
    const msg = new message_TextMessage(this.inputMsg.value);
    this.inputMsg.value = "";
...
const start = () => {
  ...
  const timeline = new components_Timeline();
